...
if(isset($_POST['save'])){
	...
	$rmethod=$_POST['rmethod'];		
	$sql= "UPDATE employee SET rmember='$rmember', rmethod='$rmethod' WHERE id='$id'";
			...
			<div class="row">
				<div class="col-md-2">
					<ul class="nav nav-pills nav-stacked" id="stackmenu">
						...
						<li role="presentation" class="active"><a href="reportto.php?id=<?php echo $row2['id']; ?>">Report To</a></li>
					...
					<div class="col-md-11">
						<form action="#" method="post" class="form-group" enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-12">
									<div class="box2">
										<strong>Reporting Member Name</strong>
										<input type="text" name="rmember" value="<?php echo $row2['rmember']; ?>" class="form-control" required />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="box2">
										<strong>Reporting Method</strong>
										<select name="rmethod" value="<?php echo $row2['rmethod']; ?>" class="form-control">
											<option value="Email" checked >Email</option>
