...
if(isset($_POST['save'])){
	...
	$sdate=$_POST['sdate'];		
	$ldate=$_POST['ldate'];		
	$sql= "UPDATE employee SET cname='$cname', ctitle='$ctitle', sdate='$sdate', ldate='$ldate'  WHERE id='$id'";
			...
			<div class="row">
				<div class="col-md-2">
					<ul class="nav nav-pills nav-stacked" id="stackmenu">
						...
						<li role="presentation" class="active"><a href="work.php?id=<?php echo $row2['id']; ?>">Experience</a></li>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="box2">
										...
										<input type="text" name="cname" value="<?php echo $row2['cname']; ?>" class="form-control" required />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="box2">
										...
										<input type="text" name="ctitle" value="<?php echo $row2['ctitle']; ?>" class="form-control" required />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="box2">
										<strong>From</strong>
										<input type="text" name="sdate" value="<?php echo $row2['sdate']; ?>" class="form-control" required />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="box2">
										<strong>To</strong>
										<input type="text" name="ldate" value="<?php echo $row2['ldate']; ?>" class="form-control" required />
									</div>
								</div>
							</div>
							<div class="row">
