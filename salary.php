...
if(isset($_POST['save'])){
	...
	$ctc=$_POST['ctc'];	
	$scomm=$_POST['scomm'];		
	$sql= "UPDATE employee SET bpay='$bpay', crncy='$crncy', ctc='$ctc', scomm='$scomm' WHERE id='$id'";
			...
			<div class="row">
				<div class="col-md-2">
					<ul class="nav nav-pills nav-stacked" id="stackmenu">
						...
						<li role="presentation" class="active"><a href="salary.php?id=<?php echo $row2['id']; ?>">Salary</a></li>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="box2">
										...
										<input type="text" name="bpay" value="<?php echo $row2['bpay']; ?>" class="form-control" required />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="box2">
										...
										<input type="text" name="crncy" value="<?php echo $row2['crncy']; ?>" class="form-control" required />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="box2">
										<strong>C.T.C.</strong>
										<input type="text" name="ctc" value="<?php echo $row2['ctc']; ?>" class="form-control" required />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="box2">
										...
										<textarea name="scomm" class="form-control" rows="5"></textarea>
									</div>
								</div>
							</div>
							<div class="row">
